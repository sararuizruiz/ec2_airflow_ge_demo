...
ge_root_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'demo')
ge_val_monthlychk = BashOperator(
    task_id='GE_val_monthlychk',
...
# snowflake_query2 = ["""alter table ABT_NYC_TAXI add column error integer""",
#     """insert into  ABT_NYC_TAXI select * from RAW_MONTHLY_TAXI;""",
#     """alter table ABT_NYC_TAXI drop column error;""",]
# import_to_abt_nyc_taxi = SnowflakeOperator(
#     task_id='import_to_abt_nyc_taxi',
